 ...
 */
@TeleOp(name="Tim's A Good Boy", group="8617")
public class TimsAGoodBoy extends LinearOpMode {
...
//            processKicker();
            processNeck();
            //keepPosition(0,0,0);
            goTo(0,0,0,robot.odom.getPosY(),robot.odom.getPosX(),robot.angleWrap(robot.odom.getHeading()*180/3.14159265),elapsedTime);
...
//    }
    ...
    void goTo(double xTarget, double yTarget, double zTarget, double xPos, double yPos, double zPos, double dt) {
        if (!gamepad1_circle_now) {
            ...
            double zError = zTarget - zPos; // TODO: check this
